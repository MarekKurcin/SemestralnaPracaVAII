        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="index.php?page=accommodations&action=store" method="POST" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="popis" name="popis" rows="4"><?= htmlspecialchars($data['popis'] ?? '') ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="adresa" class="form-label">Adresa *</label>
                            <input type="text" class="form-control" id="adresa" name="adresa" 
                                   value="<?= htmlspecialchars($data['adresa'] ?? '') ?>" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="kapacita" name="kapacita" 
                                       value="<?= htmlspecialchars($data['kapacita'] ?? '') ?>" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="cena_za_noc" name="cena_za_noc" 
                                       value="<?= htmlspecialchars($data['cena_za_noc'] ?? '') ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="vybavenie" name="vybavenie" 
                                   value="<?= htmlspecialchars($data['vybavenie'] ?? '') ?>"
