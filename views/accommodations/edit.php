...
<div class="container py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Upraviť ubytovanie</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="bi bi-pencil"></i> Upraviť ubytovanie</h4>
                </div>
                <div class="card-body">
                    <?php if (!empty($errors)): ?>
                    ...
                    <form action="index.php?page=accommodations&action=update&id=<?= $accommodation['id'] ?>" 
                          method="POST" id="accommodationForm" novalidate>
                        
                        <div class="mb-3">
                            <label for="nazov" class="form-label">Názov ubytovania *</label>
                            <input type="text" class="form-control" id="nazov" name="nazov" 
                                   value="<?= htmlspecialchars($accommodation['nazov'] ?? '') ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="popis" name="popis" rows="4"><?= htmlspecialchars($accommodation['popis'] ?? '') ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="adresa" class="form-label">Adresa *</label>
                            <input type="text" class="form-control" id="adresa" name="adresa" 
                                   value="<?= htmlspecialchars($accommodation['adresa'] ?? '') ?>" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="kapacita" name="kapacita" 
                                       value="<?= htmlspecialchars($accommodation['kapacita'] ?? '') ?>" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="cena_za_noc" name="cena_za_noc" 
                                       value="<?= htmlspecialchars($accommodation['cena_za_noc'] ?? '') ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="vybavenie" name="vybavenie" 
                                   value="<?= htmlspecialchars($accommodation['vybavenie'] ?? '') ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="obrazok" name="obrazok" 
                                   value="<?= htmlspecialchars($accommodation['obrazok'] ?? '') ?>"
                                   placeholder="https://...">
                        </div>

                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="aktivne" name="aktivne" 
                                   <?= ($accommodation['aktivne'] ?? true) ? 'checked' : '' ?>>
                            <label class="form-check-label" for="aktivne">Aktívne (viditeľné pre návštevníkov)</label>
                        </div>
